 ...
 *
 */
public class Video_40_UserBean {
	...
	// VIDEO 40 ADDITIONS:
	private String info = "The Bean says, \"Yo, I have some info!\"";
	
	public String getInfo(){
		return info;
	}
	// END Video 40 Additions
	...
	public Video_40_UserBean(){}
	
	// Custom constructor
	public Video_40_UserBean(String email, String password) {
		super();
		this.email = email;
