...
/**
 * A JavaBean that is virtually identical to Video_23_UserBean.java 
 * except that this Bean uses validation.
 * 
 * @author Ross Studtman
 *
 */
public class Video_24_UserBean {
	 ...
	 * Set to an empty string "" so that it will not be shown in the header for errors
	 * in Video_25_selfValidatingForm.jsp
	 */
	private String errorMessage = "";
	
	// Default constructor -- JavaBean must have one.
	public Video_24_UserBean(){}
	
	// Custom constructor
	public Video_24_UserBean(String email, String password) {
		super();
		this.email = email;
